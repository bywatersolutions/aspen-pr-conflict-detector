...
### Cluster 1 — 12 PRs, 13 conflict(s)

**Authors:** @Jacobomara901, @JonahCWilson, @LiYanjun19, @gmcharlt, @kidclamp, @kylemhall, @lucasmontoya13

**Files:** `code/web/release_notes/26.09.00.MD`, `code/web/sys/SystemVariables.php`
